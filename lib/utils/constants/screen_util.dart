...
//returns certain percent of full screen width
  num partFW(num percent) {
    num partFw = percent * screenWidth / 100;
    return partFw;
  }

//returns certain percent of full screen height
  num partFH(num percent) {
    num partFh = percent * screenHeight / 100;
    return partFh;
  }
}
